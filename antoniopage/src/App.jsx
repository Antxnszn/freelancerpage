...
function App() {
  ...
  <div style={{ color: '#1F1717' }} className="font-sans font-family:sans-serif font-text font-medium antialiased text-lg bg-wash dark:bg-wash-dark leading-base">
    ...
    <body className="bg-transparent">
      ...
      <p className="tracking-wide md:mx-[8em] lg:mx-[15em] text-center mt-5 mb-5 font-light">Hi, I'm Antonio, an<span style={{color: '#1F1717' }} className="px-2 font-normal">Artificial Intelligence Engineering</span>student with a deep passion for <span className='font-normal'>algorithms</span> and <span className='font-normal'>mathematics</span>.</p>
      <p class="tracking-wide md:mx-[8em] lg:mx-[15em] text-center mb-5 font-light">Though I may not have professional experience yet, I'm dedicated to honing my skills through personal projects. My goal is to master the tools and technologies that drive innovation in the industry.</p>
      <p class="tracking-wide md:mx-[8em] lg:mx-[15em] text-center mb-5 font-light">Currently, I'm diving into web development, learning to create dynamic and responsive web applications using tools like CSS, HTML5, Node.js, JavaScript, and React.</p>
